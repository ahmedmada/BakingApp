...
public class RecipesAdapter extends RecyclerView.Adapter<RecipesAdapter.mViewHolder> {
    ...
    @NonNull
    @Override
    public RecipesAdapter.mViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecipesAdapter.mViewHolder holder, int position) {
