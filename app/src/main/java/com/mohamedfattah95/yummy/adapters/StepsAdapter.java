package com.mohamedfattah95.yummy.adapters;
...
public class StepsAdapter extends RecyclerView.Adapter<StepsAdapter.mViewHolder> {
    ...
    @NonNull
    @Override
    public StepsAdapter.mViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View rootView = LayoutInflater.from(mContext)
                .inflate(R.layout.item_step, parent, false);

        return new StepsAdapter.mViewHolder(rootView);
    }

    @Override
    public void onBindViewHolder(@NonNull StepsAdapter.mViewHolder holder, int position) {
